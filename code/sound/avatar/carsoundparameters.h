...
// Declaration (not definition - that's in carsoundparameters.cpp) of the
// explicit specialization of radLinkedClass<carSoundParameters>'s static
// data members. Must appear before any use that would otherwise implicitly
// instantiate radLinkedClass<carSoundParameters> first - [temp.expl.spec]
...
template<> carSoundParameters * radLinkedClass< carSoundParameters >::s_pLinkedClassHead;
template<> carSoundParameters * radLinkedClass< carSoundParameters >::s_pLinkedClassTail;
